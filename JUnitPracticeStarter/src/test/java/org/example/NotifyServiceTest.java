...
public class NotifyServiceTest {
    ...
    public void test1() throws Exception{
        ...
        verify(sendEMailService).send(toEmailAddressCaptor.capture(), subjectCaptor.capture(), bodyCaptor.capture());        
        assertEquals("to1@fuga.com", toEmailAddressCaptor.getValue());
        assertEquals("メッセージ通知", subjectCaptor.getValue());
        assertEquals("こんにちは", bodyCaptor.getValue());
